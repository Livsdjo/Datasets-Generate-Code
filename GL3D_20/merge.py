...
def data_merge(config):
    ...
    data_folder = os.path.join(config.datasets_output_path, "COLMAP_heheA")
    ...
    data_folder = os.path.join(config.datasets_output_path, "COLMAP_heheB")
    ...
    data_folder = os.path.join(config.datasets_output_path, "COLMAP_heheC")
    ...
    data_folder = os.path.join(config.datasets_output_path, "COLMAP_20")
