...
def dataset_generate_main(config):
    ...
    # 4. 左右6维旋转信息
    # 5. 其他信息
    temp = visualize_new_class_def("./Input_Data/5a533e8034d7582116e34209_20/", 0)
    ...
    for i in trange(image_pair_count):
        visualize_new_class_def_inst = visualize_new_class_def("./Input_Data/5a533e8034d7582116e34209_20/", i)
    ...
    if 1:
        print("结束")
        # train_data_path = "E:/NM-Net-Initial/datasets/COLMAP_hehe_C/train"
        # valid_data_path = "E:/NM-Net-Initial/datasets/COLMAP_hehe_C/valid"
        # test_data_path = "E:/NM-Net-Initial/datasets/COLMAP_hehe_C/test"

        train_data_path = os.path.join(config.datasets_output_path, "/COLMAP_heheB/train")
        valid_data_path = os.path.join(config.datasets_output_path, "/COLMAP_heheB/valid")
        test_data_path = os.path.join(config.datasets_output_path, "/COLMAP_heheB/test")
