...
def dataset_generate_main():
    ...
    # 4. 左右6维旋转信息
    # 5. 其他信息
    temp = visualize_new_class_def("./Input_Data/588a34cfec4d5a1c088ea8d1", 0)
    ...
    for i in trange(image_pair_count):
        visualize_new_class_def_inst = visualize_new_class_def("./Input_Data/5a533e8034d7582116e34209", i)
