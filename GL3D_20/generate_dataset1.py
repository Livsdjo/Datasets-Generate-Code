...
"""
       5c0d13b795da9479e12e2ee9 dataset 生成代码
"""
def dataset_generate_main(config):
    ...
    # 4. 左右6维旋转信息
    # 5. 其他信息
    temp = visualize_new_class_def("./Input_Data/5c0d13b795da9479e12e2ee9_20/", 0)
    ...
    for i in trange(image_pair_count):
        visualize_new_class_def_inst = visualize_new_class_def("./Input_Data/5c0d13b795da9479e12e2ee9_20/", i)
    ...
    if 1:
        print("结束")
        # train_data_path = "E:/NM-Net-Initial/datasets/COLMAP_hehe_L/train"
        # valid_data_path = "E:/NM-Net-Initial/datasets/COLMAP_hehe_L/valid"
        # test_data_path = "E:/NM-Net-Initial/datasets/COLMAP_hehe_L/test"
        train_data_path = os.path.join(config.datasets_output_path, "/COLMAP_heheA/train")
        valid_data_path = os.path.join(config.datasets_output_path, "/COLMAP_heheA/valid")
        test_data_path = os.path.join(config.datasets_output_path, "/COLMAP_heheA/test")
