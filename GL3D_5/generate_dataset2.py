...
from Sift import get_model, loc_model
...
def dataset_generate_main(config):
    a = 0
    all_index = []
    for i in trange(9000):   # 4501 9000
        visualize_new_class_def_inst = visualize_new_class_def("./Input_Data/57102be2877e1421026358af_5/", i)
    ...
    print("长度", len(select_index_result))
    cidx_list = []
